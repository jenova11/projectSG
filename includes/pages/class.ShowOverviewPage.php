					...
					if($messageColor[$data['message_type']]){
						...
						$background = '';
                                        ...
                                        if($data['message_type'] == 3){
                                            ...
                                            //$hey = '<a href="#" style="color:red;" OnClick=\'f("CombatReport.php?raport=4fe1e67f074de2d705f1437a944ee1a11404142344", "");\' >Rapport de combat [1:28:13]</a>';
                                            $ho = $data['message_subject'];
                                            //$hey = str_replace('<a href="#" style="color:red;" onclick', '',$ho);
                                            $hey = explode('f("',$ho);
                                            $hey = explode('", "")',$hey[1]);
                                            //$data['message_subject'] = 
                                            //print_r($hey);
                                            $data['message_hef'] = $hey[0];
                                            $hi = explode('Rapport de combat',$hey[1]);
                                            $data['message_subject'] = 'Rapport de combat'.$hi[1];
