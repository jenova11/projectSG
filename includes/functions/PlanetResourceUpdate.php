            ...
            if ($CurrentPlanet['control_type'] == 1) {
                ...
                if ($CurrentPlanet['planet_type'] == 1) {//Habitable
                    if ($ProdID == 204 && $CurrentPlanet['module_minier'] > 0) {//uniquement les modules minier
                        ...
                        $Caps['metal_perhour'] += (Production::current_production(Production::production_amount($metal_prod, $geologe_boost) + Production::production_amount($metal_prod, $geologieTech_boost), $post_porcent));
                        $Caps['crystal_perhour'] += Production::current_production(Production::production_amount($crystal_prod, $geologe_boost) + Production::production_amount($crystal_prod, $geologieTech_boost), $post_porcent);
