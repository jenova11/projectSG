            ...
            foreach ($fleet as $a => $b) {
                if ($b != '') {
                    ...
                    if ($FleetRow["fleet_mess"] != "1" && $a[0] == "225") {
                        ...
                        SendSimpleMessage($CurrentUserID, '0', $FleetRow['fleet_start_time'], 0, $lang['sys_mess_qg'], 'Rapport d\'analise', $SpyMessage);
